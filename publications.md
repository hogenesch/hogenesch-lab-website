...
<header class="page-header">
  ...
  <p class="lede">
    A short list of influential public papers spanning molecular clock biology, circadian
    transcriptomics, community resources, and human circadian genomics.
  </p>
</header>
...
- Panda S, Hogenesch JB, Kay SA. [Circadian rhythms from flies to human](https://pubmed.ncbi.nlm.nih.gov/12015613/). *Nature*. 2002.
