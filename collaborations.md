...
<nav class="secondary-nav" aria-label="More">
  <a href="lineage.html">Scientific Lineage</a><a class="active" href="collaborations.html">Collaborations</a><a href="press.html">In the Press</a><a href="http://circadb.hogeneschlab.org/" target="_blank" rel="noopener">CircaDB</a>
</nav>
</div>
</div>
...
<header class="page-header">
  ...
  <h1>Long-term scientific partnerships</h1>
  <p class="lede">
    Many of the Hogenesch Lab's most influential contributions have emerged from sustained
    collaborations that combine experimental biology, genomics, and computational methods.
    These partnerships have produced widely used datasets, algorithms, and public resources
    for circadian biology and human genomics.
  </p>
</header>
...
<li><strong>Gene Wiki</strong> - a project integrating gene annotation with Wikipedia to create a widely used open knowledge base for human genes.</li>
<li><strong>Clock Gene Wiki</strong> - a curated resource focused on circadian clock components and their biological functions.</li>
<li><strong>CircaDB</strong> - a database enabling researchers to explore circadian gene expression across tissues and datasets.</li>
</ul>
<p>These efforts helped establish a model for open, community-driven biological knowledge resources that continue to support research across genomics and circadian biology.</p>
</section>
...
<div class="callout">
<h2>Related Pages</h2>
<p><a href="publications.html">Selected Publications</a> for landmark papers from the lab's broader research program.</p>
<p><a href="resources.html">Resources</a> for software, datasets, and public tools including CircaDB.</p>
</div>

<footer class="page-footer">
<p>Long-term collaborations have been central to the lab's public datasets, algorithms, and community resources.</p>
</footer>
