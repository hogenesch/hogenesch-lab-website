...
<header class="page-header">
  ...
  <h1>Methods, software, and public datasets</h1>
  <p class="lede">
    The lab's public-facing tools and datasets make rhythmic biology easier to analyze,
    compare, and reuse.
  </p>
</header>
...
<div class="resource-card">
<h2>Human Circadian Resource</h2>
<p>The published human tissue resource built from CYCLOPS-ordered transcriptomic data with applications to circadian medicine.</p>
...
<p>This page highlights stable public resources rather than news, announcements, or software release notes.</p>
</footer>
